...
- (void)viewDidLoad {
    ...
    if(IS_IPAD)
    {
        MapviewDemoViewController *mapviewDemoController = [[MapviewDemoViewController alloc] initWithNibName:@"MapviewDemoViewController~iPad" bundle:nil];
        
        mapviewDemoController.title = @"MapViewDemo";
        
        LocationDemoViewController *locationDemoController = [[LocationDemoViewController alloc] initWithNibName:@"LocationDemoViewController~iPad" bundle:nil];
        locationDemoController.title = @"LocationDemo";
        
        AnnotationDemoViewController *annotationDemoController = [[AnnotationDemoViewController alloc] initWithNibName:@"AnnotationDemoViewController~iPad" bundle:nil];
